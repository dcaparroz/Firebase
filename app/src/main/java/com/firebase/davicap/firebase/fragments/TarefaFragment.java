package com.firebase.davicap.firebase.fragments;
...
import com.firebase.davicap.firebase.adapter.RecyclerViewAdapter;
...
public class TarefaFragment extends Fragment {
    ...
    private void getAll(DataSnapshot dataSnapshot){
        ...
        recyclerViewAdapter = new RecyclerViewAdapter(tarefas,getContext());
